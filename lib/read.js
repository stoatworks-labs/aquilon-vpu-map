...
import { MIXER_IDS, MIXER_PROPS, SCALERS } from '../public/vpu.js';
...
export async function readMapping(client, { which, device = '1' } = {}) {
  ...
  for (const id of MIXER_IDS) {
    ...
    if (isAvailable === undefined) {
      ...
      rec.mixerAllocation = {
        usedOnOutPipe1: await client.tryGet(`${b}/mixerAllocation/@props/usedOnOutPipe1`),
        usedOnOutPipe2: await client.tryGet(`${b}/mixerAllocation/@props/usedOnOutPipe2`),
      };
      rec.scalers = {};
